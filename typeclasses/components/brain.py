"""Bounded model reasoning over inventory capabilities."""

import json
from twisted.internet.threads import deferToThread
from typeclasses.objects import Object
from systems.agency import budget_task, decision_limit, has_budget
...
@persisted_typeclass("typeclasses.agency.Brain")
class Brain(Object):
    ...
    def _step(self, actor, episode):
        ...
        def receive(decision):
            ...
            actor.ndb.agency_state = "waiting"
            outcome["continue"] = not tool.ENDS_BURST
        ...
        try:
            ...
            providers = [asdict(provider) for provider in get_actor_providers()]
